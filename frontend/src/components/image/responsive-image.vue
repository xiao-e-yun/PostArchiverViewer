...
export default {
  ...
  computed: {
    ...
    defaultImage() {
      const finalWidth = this.getWidthAdaptedToWidthOnScreen(
        this.defaultWidth,
        this.widthOnScreen,
      );
    ...
    srcset() {
      ...
      if (
        ...
        return this.getSrcsetSizes("all", this.widthOnScreen)
          .map((finalWidth) => {
            return (
        ...
        return this.getSrcsetSizes("desktop", this.widthOnScreen)
          .map((finalWidth) => {
            return (
              this.getImageUrlWithWidthAndHeight(
                finalWidth,
    ...
    tabletSrcset() {
      return this.getSrcsetSizes("tablet", this.widthOnScreenTablet)
        .map((finalWidth) => {
          return (
            this.getImageUrlWithWidthAndHeight(
              finalWidth,
    ...
    smartphoneSrcset() {
      return this.getSrcsetSizes("smartphone", this.widthOnScreenSmartphone)
        .map((finalWidth) => {
          const result =
            this.getImageUrlWithWidthAndHeight(
              finalWidth,
