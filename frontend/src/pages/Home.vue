...
<template>
  <RouterLink to="/authors" class="block mb-8 group">
  ...
  <RouterLink to="/posts" class="block mb-8 group">
    <div class="flex justify-between">
      <h1 class="text-base lg:text-2xl">
  ...
  <RouterLink to="/tags" class="block mb-8 group">
    <div class="flex justify-between">
      <h1 class="text-base lg:text-2xl">
  ...
  <RouterLink to="/collections" class="block mb-8 group">
    <div class="flex justify-between">
      <h1 class="text-base lg:text-2xl">
  ...
  <RouterLink to="/platforms" class="block mb-12 group">
    <div class="flex justify-between">
      <h1 class="text-base lg:text-2xl">
